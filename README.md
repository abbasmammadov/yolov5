...
## Train
!python -m torch.distributed.run --nproc_per_node 4 --master_port 1 train.py --data [path to the yaml file generated by preprocess script] --weights [which pretrained model you want] --device 0,1,2,3 --batch-size -1 --epochs [number]

weights = [(--img 640) -> yolov5n.pt, yolov5s.pt, yolov5m.pt, yolov5l.pt, yolov5x.pt; (--img 1280) -> yolov5n6.pt, yolov5s6.pt, yolov5m6.pt, yolov5l6.pt, yolov5x6.pt]
